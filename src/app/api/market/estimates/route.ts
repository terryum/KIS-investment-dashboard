...
/**
 * GET /api/market/estimates
 * Fetch estimated earnings (consensus) via KIS HHKST668300C0.
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const url = `${KIS_BASE_URL}/uapi/domestic-stock/v1/quotations/estimate-perform?${params.toString()}`;
