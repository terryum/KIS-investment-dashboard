...
- 차이(평가 - 매입): 약 +3,370,000원 (채권 가격 상승분)

### [2026-04-04] 주말/공휴일 데이터 주의

**관찰**: 토요일(2026-04-04)에 API 조회 시, 국내주식(TTTC8434R)과 해외주식(TTTS3012R)은 정상 데이터를 반환했지만, 일부 금액 필드(특히 채권 평가금)가 부정확하거나 누락될 수 있습니다. 정확한 검증은 평일 장 마감 후에 수행하는 것을 권장합니다.
